...
namespace sem2 {
    ...
    public:
        ...
        virtual std::unique_ptr<sem3::IIterator<T>> getIterator() const = 0;
        ...
        virtual std::unique_ptr<ISequence<T>>
        ...
        virtual const T &operator[](unsigned index) const { return get(index); }
    };
